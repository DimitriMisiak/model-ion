...
cir = Circuit(fr"""
    ...
    W 2_p0 2_r0; right, ultra thick
    W 2_r0 2_i0; right, ultra thick
    W 2_i0 2_ej0; right, ultra thick
    W 2_ej0 2_0; right, ultra thick
    ...
    W 2_p 2_r; right
    Zhemt2 2_r 2_r0 {{{Zhemt_Cfb}}}; down, l=Z_{{hemt}}
    W 2_r 2_i; right
    In2 2_i 2_i0 noise {{{InN}}}; down, l=i_{{n,N}}, color=red
    W 2_i 2_ej; right
    Ij2 2_ej 2_ej0 noise {{{IjN}}}; down, l=i_{{j,N}}, color=red
...
Y_dict = dict()
Y_dict['A'] = (cir_step.admittance('A')/s).evalf()
Y_dict['S_A'] = (cir_step.admittance('S_A')/s).evalf()
...
# signal = cir_eval.kill_except('Ibulk')['S_A'].V(s)
...
for source in tqdm(signal_sources):
    ...
    signal_expr = cir_aux['S_A'].V(j*omega)(f).evalf()
...
for source in tqdm(noise_sources):
    ...
    voutput_source = cir_source['S_A'].V.n
...
# plt.figure()
# plt.loglog(freq_array, noise_dict['Ij2']/noise_dict['Vj1'], label='2')
# plt.loglog(freq_array, noise_dict['Ij3']/noise_dict['Vj1'], label='3')
# plt.loglog(freq_array, noise_dict['Ij4']/noise_dict['Vj1'], label='4')
# plt.legend()
# plt.grid()
